...
import { fetchZonesByGym, fetchClimbsByZones, fetchUserAscentsByClimbs, fetchUserFavorites, toggleFavorite as dbToggleFavorite } from '@/lib/queries'
...
export default function DiscoverPage() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      const zones = await fetchZonesByGym(id)
      if (zones.length === 0) {
        setLoading(false)
        return
      }
